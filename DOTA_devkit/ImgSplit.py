...
if __name__ == '__main__':
        ...
        for win in [1024,608]:
            ...
            for partition in ['train','val']:
                ...
                basepath = f"/Nas/DOTA1_0/{partition}"
                outpath = f"/Nas/DOTA1_0/split_ss_dota1_0_glasgow_{win}/{partition}"

                os.makedirs(f"/Nas/DOTA1_0/split_ss_dota1_0_glasgow_{win}",exist_ok=True)
