...
#     PATH_TO_CKPT = f'/iqf/object_detection/{model}/graph.pbtxt'
#     testsetpath = f'/Nas/DOTA1_0/split_ss_dota1_0_glasgow_{cropsz}/val/val.txt'
    RESULT_PATH = f'/Nas/DOTA1_0/split_ss_dota1_0_glasgow_{cropsz}/results/{model}/split'
    RESULT_MERGE = f'/Nas/DOTA1_0/split_ss_dota1_0_glasgow_{cropsz}/results/{model}/merge'
    TASK_SPLIT = f'/Nas/DOTA1_0/split_ss_dota1_0_glasgow_{cropsz}/results/{model}/TaskSplit'
    TASK_MERGE = f'/Nas/DOTA1_0/split_ss_dota1_0_glasgow_{cropsz}/results/{model}/TaskMerge'
